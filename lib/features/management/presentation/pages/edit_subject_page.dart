...
class _EditSubjectPageState extends State<EditSubjectPage> {
  ...
  Future<void> _loadData() async {
    ...
    if (widget.subjectId != null) {
      ...
      if (_selectedPillar != null) {
        translations = await _subjectService.getTranslations(
          _selectedPillar!,
          widget.subjectId!,
        );
      }
  ...
  Widget build(BuildContext context) {
    ...
    final activeLangs =
        _langService.activeLanguageCodes.toList()..sort(
          (a, b) => _langService
              .getLanguageName(a)
              .compareTo(_langService.getLanguageName(b)),
        );
      ...
      builder: (context, _) {
        final String pillarName =
            _selectedPillar != null
                ? (pillars
                        .firstWhere((p) => p.id == _selectedPillar)
                        .translations[TranslationService()
                        .currentLocale
                        .languageCode] ??
                    pillars.firstWhere((p) => p.id == _selectedPillar).name)
                : '';
        final String titleText =
            isNew ? pillarName : '$pillarName > ${widget.subjectId}';
                          ...
                          children: [
                            TextField(
                              ...
                              decoration: const InputDecoration(
                                labelText: 'Subject ID (Internal Name)',
                                  ...
                                  return Padding(
                                    ...
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            'Name in ${_langService.getLanguageName(lang)}',
