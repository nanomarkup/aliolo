                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _filterChip(
                        context.t('on_dashboard'),
                        _filterOnDashboardOnly,
                        (v) => setState(() {
                          _filterOnDashboardOnly = v;
                          _applyFilters();
                        }),
                      ),
                    ],
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Text(
                                        '$pillarName • ${s.cardCount} ${context.t('cards_label')}',
                                      ),
                                      const SizedBox(width: 8),
                                      Text(
                                        '• ${context.t('by_author', args: {'name': s.ownerName ?? '...'})}',
                                      ),
                                    ],
                                  ),
                                ],
                              ...
                              trailing: ElevatedButton.icon(
                                ...
                                icon: Icon(
                                  s.isOnDashboard ? Icons.remove : Icons.add,
                                ),
                                label: Text(
                                  s.isOnDashboard
                                      ? context.t('remove')
                                      : context.t('add_to_dashboard'),
                                ),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            context.t(
                              'by_author',
                              args: {'name': widget.subject.ownerName ?? '...'},
                            ),
                            style: const TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 18,
                          ...
                          Text(
                            '${widget.subject.cardCount} ${context.t('cards_label')}',
                      ...
                      ElevatedButton.icon(
                        onPressed: () async {
                          await cardService.toggleSubjectOnDashboard(
                            widget.subject.id,
                            !widget.subject.isOnDashboard,
                          );
                          if (mounted)
                            Navigator.pop(
                              context,
              ...
              child: FutureBuilder<List<CardModel>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (!snapshot.hasData || snapshot.data!.isEmpty)
                    return Center(child: Text(context.t('no_cards_found')));
