  ...
  void _showSavedMsg() {
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(context.t('setting_saved')), duration: const Duration(seconds: 1)),
      );
    }
  }
            ...
            appBar: AppBar(
              title: DragToMoveArea(
                child: SizedBox(
                  ...
                  child: Text(context.t('settings'), style: const TextStyle(color: appBarColor)),
                ),
              ),
                ...
                child: Column(
                  children: [
                    Expanded(
                      child: ListView(
                        children: [
                          _buildSectionTitle(context.t('general_preferences'), currentSessionColor),
                          Card(
                            child: Column(
                              children: [
                                SwitchListTile(
                                  ...
                                  secondary: Icon(Icons.vertical_split, color: currentSessionColor),
                                  value: _sidebarLeft,
                                ...
                                SwitchListTile(
                                  ...
                                  secondary: Icon(Icons.volume_up, color: currentSessionColor),
                                  value: _soundEnabled,
                                ...
                                SwitchListTile(
                                  ...
                                  secondary: Icon(Icons.emoji_events, color: currentSessionColor),
                                ...
                                ListTile(
                                  ...
                                  leading: Icon(Icons.translate, color: currentSessionColor),
                                  trailing: SizedBox(
                                    width: 150,
                                    child: DropdownButton<String>(
                                      value: TranslationService().currentLocale.languageCode,
                                      underline: const SizedBox(),
                                      isExpanded: true,
                                      alignment: AlignmentDirectional.centerEnd,
                                      items: TranslationService().availableUILanguages.map((code) => 
                                        DropdownMenuItem(
                                          value: code, 
                                          alignment: AlignmentDirectional.centerEnd,
                                ...
                                ListTile(
                                  ...
                                  subtitle: Text(context.t('default_learning_language_desc')),
                                  ...
                                  trailing: SizedBox(
                                    ...
                                    child: ListenableBuilder(
                                      ...
                                      builder: (context, _) {
                                        final activeLangs = LearningLanguageService().activeLanguageCodes.map((c) => c.toUpperCase()).toList()..sort();
                                        return DropdownButton<String>(
                                          ...
                                          items: activeLangs.map((l) => DropdownMenuItem(
                                            value: l, 
                                            alignment: AlignmentDirectional.centerEnd,
                                            child: Text(LearningLanguageService().getLanguageName(l))
                                          )).toList(),
                                          onChanged: (val) {
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Icon(Icons.brightness_medium, color: currentSessionColor),
                                          const SizedBox(width: 16),
                                          Text(context.t('theme_mode'), style: const TextStyle(fontSize: 16)),
                                        ],
                                      ),
                                      ...
                                      Center(
                                        child: SegmentedButton<String>(
                                          segments: [
                                            ButtonSegment(value: 'system', label: Text(context.t('system')), icon: const Icon(Icons.brightness_auto)),
                                            ButtonSegment(value: 'light', label: Text(context.t('light')), icon: const Icon(Icons.light_mode)),
                                            ButtonSegment(value: 'dark', label: Text(context.t('dark')), icon: const Icon(Icons.dark_mode)),
                                          ],
                                          selected: {_themeMode},
                          ...
                          _buildSectionTitle(context.t('keyboard_shortcuts'), currentSessionColor),
                          Card(
                            child: Column(
                              children: [
                                ListTile(
                                  title: Text(context.t('previous_card')),
                                  subtitle: Text(context.t('ctrl_plus', args: {'key': _getKeyName(context, _shortcutPrev)})),
                                ...
                                ListTile(
                                  ...
                                  subtitle: Text(context.t('ctrl_plus', args: {'key': _getKeyName(context, _shortcutNext)})),
                                  leading: Icon(Icons.keyboard, color: currentSessionColor),
                                  trailing: const Icon(Icons.edit, size: 18),
