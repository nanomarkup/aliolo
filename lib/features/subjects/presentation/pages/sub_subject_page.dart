                ...
                children: [
                  ...
                  Theme(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (val) {
                        if (val != null) {
                          setState(() => _selectedLanguage = val.toLowerCase());
                          _authService.updateDefaultLanguage(val.toLowerCase());
                        }
                      },
                      items:
                          (() {
                            ...
                            return list
                                .map(
                                  (l) => DropdownMenuItem(
                                    value: l,
                                    child: Text(
                                      LearningLanguageService().getLanguageName(
                                        l,
                                      ),
                                    ),
                                  ),
                      ...
                      Expanded(
                        child:
                            _isLoading
                                ...
                                ? Center(
                                  child: Text(
                                    context.t('no_cards_available_lang'),
                                  ),
                                )
                                : ListView.builder(
