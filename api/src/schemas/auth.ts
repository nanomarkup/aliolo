...
export const UpdateProfileSchema = z.object({
  ...
  sidebar_left: z.number().optional().openapi({ example: 1 }),
  sound_enabled: z.number().optional().openapi({ example: 0 }),
  auto_play_enabled: z.number().optional().openapi({ example: 1 }),
  show_on_leaderboard: z.number().optional().openapi({ example: 0 }),
  show_documentation: z.number().optional().openapi({ example: 0 }),
  ...
  is_premium: z.number().optional().openapi({ example: 1 }),
