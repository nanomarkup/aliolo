...
export const UserProfileSchema = z.object({
  ...
  media_auto_play_muted: z.number().openapi({ example: 0 }),
  ...
  test_autoplay_delay_seconds: z.number().openapi({ example: 1 }),
  options_count: z.number().openapi({ example: 6 }),
  avatar_url: z.string().nullable().openapi({ example: 'https://example.com/avatar.png' }),
  avatar_original_url: z.string().nullable().optional().openapi({ example: 'https://example.com/avatar_original.png' }),
...
export const UpdateProfileSchema = z.object({
  ...
  total_xp: z.number().optional().openapi({ example: 100 }),
  current_streak: z.number().optional().openapi({ example: 5 }),
  max_streak: z.number().optional().openapi({ example: 10 }),
  ...
  media_auto_play_muted: z.union([z.boolean(), z.number()]).optional().openapi({ example: 0 }),
  ...
  test_autoplay_delay_seconds: z.number().optional().openapi({ example: 2 }),
  ...
  avatar_original_url: z.string().optional().openapi({ example: 'https://example.com/new_avatar_original.png' }),
