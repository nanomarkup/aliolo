...
const landingStyles = `
  ...
  * { box-sizing: border-box; }
  ...
  @media (max-width: 640px) {
    ...
    .brand { gap: 8px; }
    .brand-name { gap: 8px; font-size: 20px; }
    .brand-name img { width: 36px; height: 36px; border-radius: 10px; }
    nav { gap: 2px; }
    ...
    .hero { gap: 24px; margin-bottom: 56px; }
    ...
    .proof-row { gap: 14px; }
    .proof { min-width: 100%; }
    .preview-caption { flex-direction: column; gap: 10px; }
    .final-cta { padding: 24px; flex-direction: column; align-items: stretch; }
    .final-cta .btn { width: 100%; }
    footer { margin-top: 48px; padding: 42px 0 54px; }
  }
  ...
  <header>
    <div class="shell brand">
      ...
      <nav aria-label="Site navigation">
        <a class="desktop-link" href="#features">Features</a>
        <a class="desktop-link" href="#workflow">How it works</a>
        <a class="desktop-link" href="#pricing">Pricing</a>
        <a href="/?login=1" class="nav-login">Log in</a>
        <a href="/login" class="nav-cta">Create free account</a>
      </nav>
    </div>
  </header>
  ...
  <main class="shell" id="main-content">
    <section class="hero">
      <div class="hero-copy">
        ...
        <h1>Learn visually. Remember longer.</h1>
        <p>Turn images, audio, video, and text into structured flashcards. Learn with context, review at the right time, and test what you can truly recall.</p>
        <div class="cta-group">
          <a href="/login" class="btn btn-primary">Create free account</a>
          <a href="/?login=1" class="btn btn-secondary">Log in</a>
        </div>
      ...
      <aside class="hero-panel" aria-label="Aliolo study workflow preview">
        <figure class="product-preview">
          ...
          <figcaption class="preview-caption">
            <div>
              <strong>Recognition before recall</strong>
              <span>A real Aliolo lesson using image, text, audio, and guided navigation.</span>
            </div>
            <div class="preview-chip">Learn mode</div>
          </figcaption>
        </figure>
      </aside>
    </section>
    ...
    <section class="section" id="features">
      <div class="section-heading">
        <h2>Everything you need to turn exposure into recall.</h2>
        <p>Build recognition with rich media, keep larger libraries organized, and revisit material before it fades.</p>
      </div>
      <div class="feature-grid">
        <article class="feature-card">
          ...
          <h3>Learn with more than text</h3>
          <p>Use images, audio, video, and flexible prompts when the subject depends on recognition and context.</p>
        </article>
        <article class="feature-card">
          ...
          <h3>Review before it fades</h3>
          <p>Spaced repetition and progress tracking bring important material back at a useful time.</p>
        </article>
        <article class="feature-card">
          ...
          <h3>Grow beyond one deck</h3>
          <p>Organize curated or custom material into pillars, folders, subjects, and collections that stay usable.</p>
        </article>
      </div>
    </section>
    ...
    <section class="section" id="workflow">
      <div class="section-heading">
        <h2>A clear path from “I should study” to “I know this.”</h2>
        <p>One focused workflow keeps the next step obvious without flattening every subject into the same kind of card.</p>
      </div>
      <div class="steps">
        <article class="step">
          <strong>01</strong>
          <h3>Choose the right material</h3>
          <p>Start with a curated subject or build a focused library for an exam, language, profession, or personal goal.</p>
        </article>
        <article class="step">
          <strong>02</strong>
          <h3>Learn with context</h3>
          <p>Build recognition through guided cards and available media before asking your memory to work unaided.</p>
        </article>
        <article class="step">
          <strong>03</strong>
          <h3>Test real recall</h3>
          <p>Move into focused testing to expose weak spots, reinforce retrieval, and make progress measurable.</p>
        </article>
      </div>
    </section>
    ...
    <section class="section" id="pricing">
      <div class="section-heading">
        <h2>Start free. Upgrade when you need the full workflow.</h2>
        <p>Create an account without payment. Premium adds spaced repetition, creation, testing, autoplay, private organization, and deeper customization.</p>
      </div>
      <div class="pricing-grid">
        <article class="price-card">
          ...
          <a href="/pricing" class="btn btn-secondary" aria-label="View weekly plan details">View plan details</a>
        </article>
        <article class="price-card featured">
          ...
          <a href="/pricing" class="btn btn-primary" aria-label="View monthly plan details">View plan details</a>
        </article>
        <article class="price-card">
          ...
          <a href="/pricing" class="btn btn-secondary" aria-label="View yearly plan details">View plan details</a>
        </article>
      </div>
    </section>
    ...
    <section class="section">
      <div class="trust-panel">
        <div class="trust-grid">
          <div>
            <h2>Study with clarity. Subscribe with confidence.</h2>
            <p>Know what is free, what Premium adds, and where to get help before you commit.</p>
            <div class="trust-list">
              <div><strong>Free entry:</strong> Create an account and explore available learning material without entering payment details.</div>
              <div><strong>Transparent terms:</strong> Pricing, renewal, cancellation, privacy, and refund information are available before checkout.</div>
              <div><strong>Human support:</strong> Contact <a href="mailto:vitalii@nohainc.com">vitalii@nohainc.com</a> when you need help.</div>
            </div>
          </div>
          <div class="mini-faq" aria-label="Mini FAQ">
            <div>
              <strong>Do I need to create every card myself?</strong>
              No. Start with available curated subjects, then create your own material when your goal becomes more specific.
            </div>
            <div>
              <strong>Can I use Aliolo for free?</strong>
              Yes. A free account provides an entry point to the library; the pricing page explains which advanced workflows require Premium.
            </div>
            <div>
              <strong>Can I cancel a subscription?</strong>
              Yes. Subscriptions can be canceled through the channel where they were purchased, with access normally continuing through the paid period.
            </div>
          </div>
        </div>
      </div>
      <div class="final-cta">
        <div>
          <h2>Ready to make your next study session count?</h2>
          <p>Create a free account, choose a subject, and start learning visually.</p>
        </div>
