...
def main():
    print("Fetching all cards for Most Colorful Insects subject...")
    ...
    def check_translation(card_id, field, locale, global_text, current_text):
        ...
        try:
            ...
            # print(f"Error translating {global_text} to {locale}: {e}")
            pass
        return None
