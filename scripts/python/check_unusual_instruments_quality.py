...
def main():
    print("Fetching all cards for Unusual Musical Instruments subject...")
    ...
    print(f"Auditing {len(cards)} cards across {len(locales)} languages for metadata and 4 fields...")
