...
categories = [
    {"name": "Wearable technology", "wiki": "Wearable technology"},
    {"name": "Smart home", "wiki": "Smart home"},
    {"name": "Personal mobility", "wiki": "Personal mobility device"},
    {"name": "Immersive technology", "wiki": "Immersive technology"},
    {"name": "Consumer robotics", "wiki": "Domestic robot"},
    {"name": "Computing", "wiki": "Computing"},
    {"name": "Digital photography", "wiki": "Digital photography"},
    {"name": "Drones", "wiki": "Unmanned aerial vehicle"},
    {"name": "Smart healthcare", "wiki": "Digital health"},
    {"name": "Cloud computing", "wiki": "Cloud computing"},
    {"name": "Artificial intelligence", "wiki": "Artificial intelligence"},
    {"name": "Gaming", "wiki": "Video game"},
    {"name": "Clean energy technology", "wiki": "Clean technology"},
    {"name": "Audio technology", "wiki": "Sound recording and reproduction"}
]
...
def process():
    ...
    for i, cat in enumerate(categories):
        ...
        translations, img_url = get_wikipedia_info(cat['wiki'])
        ...
        if img_url:
            try:
                ...
                if i_resp.status_code == 200:
                    ...
                    storage_path = f"{owner_id}/Tech Categories/{card_id}.{ext}"
        ...
        loc_data = {}
        for lang in langs:
            name = translations.get(lang, cat['name'])
            # Clean up
            name = re.sub(r'\s*\(.*?\)', '', name).strip()
            loc_data[lang] = {"answer": name, "prompt": "", "audio_url": None}
        loc_data["global"] = {
            "answer": cat['name'], "prompt": "", "audio_url": None, "video_url": "", 
