...
SUBJECT_ID = "f59a0f9c-5d6d-4f2d-b426-eb9ca6bf2782"  # Subtraction 11-20
        ...
        for index, card in enumerate(cards, 1):
            ...
            for aliolo_lang, gtts_lang in LANG_MAPPING.items():
                ...
                if aliolo_lang in localized_answers:
                    text_to_speak = localized_answers[aliolo_lang].strip()
                
                # Fallback to English base answer (which is the standard digit e.g. "13")
                if not text_to_speak:
                    text_to_speak = base_answer
