...
sea_animals = [
  "Blue Whale", "Dolphin", "Jellyfish", "Blobfish", "Octopus", "Crab", "Starfish", 
  "Sea turtle", "Lobster", "Seahorse", "Angelfish", "Clownfish", "Swordfish", 
  "Walrus", "Eel", "Squid", "Seal", "Manatee", "Barracuda", "Manta ray", 
  "Cuttlefish", "Stargazer fish", "Humphead parrotfish"
]
...
def process():
    ...
    for i, name in enumerate(sea_animals):
        level = i + 1
        ...
        translations, img_url = get_wikipedia_info(name)
        if not img_url:
